...
function ProductCard2({ data }) {
  ...
  return (
    <div className=" mx-[150px] grid grid-cols-1 gap-[120px] sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
      {data.map((product, index) => (
        <div
          key={index}
          className={`relative ${index % 2 === 0 ? "mt-[100px]" : ""}`}
        >
          <div className="p-[20px] m-8 transition-transform transform rounded-2xl shadow-lg lg:p-5 hover:scale-105 sm:m-4 lg:m-0  ">
