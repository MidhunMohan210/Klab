          ...
          <div className="container mt-[170px]">
            <div className="grid sm:grid-cols-1 md:grid-cols-2">
              ...
              <div>
                ...
                <p className=" mt-5 max-w-lg leading-7">
                  ...
                  locally produced fresh ingredients and easy-to-follow recipes
                  so that anyone can prepare a quality home-cooked dish that
                  does not compromise on time and well-being.
                </p>
            ...
            <div className="container mt-[230px]">
              <div className="flex justify-center items-center">
                ...
                <FaRegCirclePlay className="text-white text-4xl absolute hover:scale-110 transform ease-in-out" />
              </div>
              <div className=" text-center flex justify-center mt-8 leading-7">
                <p className="max-w-2xl">
                  All Currease products are manufactured using “retort”
                  technology. Retorting is one of the major techniques used for
                  the thermal processing of food products that are packed either
                  in semi-rigid flexible laminates or in metal or alloy cans.
                  The technology provides the advantage of processing and
                  packing the food together; which makes it more commercially
                  stable with safe and effective shelf life.
                </p>
              </div>
            </div>
          </div>
